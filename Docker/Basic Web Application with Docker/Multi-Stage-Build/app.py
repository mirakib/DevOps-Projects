...
<head>
    ...
    <title>Docker & Flask Dashboard</title>
    <!-- Google Font: Poppins -->
        ...
        <div class="content-grid">
            ...
            <div class="card">
                ...
                <p>
                    ...
                    <strong>Framework:</strong> Flask (Micro-Framework)<br>
            ...
            <div class="card">
                ...
                <p>
                    <strong>Internal Port:</strong> 5000<br>
...
def hello():
    ...
    user_name = os.environ.get('GREETING_NAME', 'Docker Enthusiast')
